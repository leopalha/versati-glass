          ...
          {activeView === 'closed' && (
            ...
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="group relative flex items-center gap-3 rounded-2xl bg-gradient-to-r from-accent-500 to-gold-500 px-4 py-3 shadow-lg transition-shadow hover:shadow-xl"
              >
                {/* Icon */}
                <div className="flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-full bg-neutral-900/20">
                  <Bot className="h-6 w-6 text-neutral-900" />
                </div>

                {/* Label */}
                <div className="min-w-0 flex-shrink-0 pr-1 text-left">
                  <p className="whitespace-nowrap text-sm font-bold leading-tight text-neutral-900">
                    Assistente IA
                  </p>
                  <p className="whitespace-nowrap text-xs text-neutral-900/80">Tire suas duvidas</p>
                </div>
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="group relative flex items-center gap-3 rounded-2xl bg-[#25D366] px-4 py-3 shadow-lg transition-shadow hover:shadow-xl"
              >
                {/* WhatsApp Icon */}
                ...
                <div className="min-w-0 flex-shrink-0 pr-1 text-left">
                  ...
                  <p className="whitespace-nowrap text-xs text-white/80">Fale conosco</p>
                </div>
              </motion.button>
            </motion.div>
          )}
