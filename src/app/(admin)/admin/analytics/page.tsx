  ...
  return (
    <div className="container mx-auto space-y-6 p-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">Analytics Omnichannel</h1>
          <p className="mt-1 text-gray-600">Métricas de conversão e performance</p>
        </div>
      ...
      <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-4">
        <Card className="p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-3xl font-bold">{data.overview.totalConversations}</p>
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600">Taxa de Linking</p>
              <p className="mt-1 text-3xl font-bold">{data.overview.linkingRate.toFixed(1)}%</p>
              <p className="mt-1 text-xs text-gray-500">
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-3xl font-bold">{data.overview.conversionRate.toFixed(1)}%</p>
              <p className="mt-1 text-xs text-gray-500">
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="mt-1 text-3xl font-bold">{data.overview.avgResponseTime}min</p>
              <p className="mt-1 text-xs text-gray-500">Tempo de resposta</p>
            </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        <Card className="p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span className="text-lg font-bold">{data.byChannel.web.conversations}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-gray-600">Orçamentos</span>
              <span className="text-lg font-bold">{data.byChannel.web.quotes}</span>
            </div>
            <div className="flex items-center justify-between">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="text-lg font-bold">{data.byChannel.web.avgDuration}min</span>
            </div>
          </div>
        </Card>
        ...
        <Card className="p-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <span className="text-gray-600">Conversas</span>
              <span className="text-lg font-bold">{data.byChannel.whatsapp.conversations}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-gray-600">Orçamentos</span>
              <span className="text-lg font-bold">{data.byChannel.whatsapp.quotes}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-gray-600">Taxa de Conversão</span>
              <Badge variant="success" className="text-lg">
            ...
            <div className="flex items-center justify-between">
              <span className="text-gray-600">Duração Média</span>
              <span className="text-lg font-bold">{data.byChannel.whatsapp.avgDuration}min</span>
            </div>
          </div>
        </Card>
      </div>
      ...
      <Card className="p-6">
        <div className="mb-6 flex items-center gap-3">
          ...
          <h2 className="text-xl font-bold">Jornada Cross-Channel</h2>
        </div>

        <div className="grid grid-cols-1 gap-4 md:grid-cols-4">
          <div className="rounded-lg bg-blue-50 p-4 text-center">
            <p className="text-sm text-gray-600">Iniciaram no Site</p>
            <p className="mt-1 text-2xl font-bold text-blue-600">{data.crossChannel.startedWeb}</p>
          </div>
          <div className="rounded-lg bg-green-50 p-4 text-center">
            <p className="text-sm text-gray-600">Iniciaram no WhatsApp</p>
            <p className="mt-1 text-2xl font-bold text-green-600">
              {data.crossChannel.startedWhatsApp}
            </p>
          </div>
          <div className="rounded-lg bg-purple-50 p-4 text-center">
            <p className="text-sm text-gray-600">Mudaram de Canal</p>
            <p className="mt-1 text-2xl font-bold text-purple-600">
              {data.crossChannel.switchedChannels}
            </p>
          </div>
          <div className="rounded-lg bg-orange-50 p-4 text-center">
            <p className="text-sm text-gray-600">Converteram Cross-Channel</p>
        ...
        <div className="mt-6 rounded-lg bg-gray-50 p-4">
          <h3 className="mb-2 font-bold">Insights</h3>
          <ul className="space-y-1 text-sm text-gray-600">
            ...
            <li>• {data.overview.linkedConversations} conversas foram linkadas automaticamente</li>
          </ul>
        </div>
      </Card>
      ...
      <Card className="p-6">
        <h2 className="mb-4 text-xl font-bold">Evolução Temporal</h2>
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            <thead className="bg-gray-50">
              <tr>
                <th className="px-4 py-2 text-left">Data</th>
                <th className="px-4 py-2 text-right">Web Chat</th>
                <th className="px-4 py-2 text-right">WhatsApp</th>
                <th className="px-4 py-2 text-right">Orçamentos</th>
              </tr>
            </thead>
            <tbody>
              {data.timeline.slice(-7).map((day, idx) => (
                <tr key={idx} className="border-t">
                  ...
                  <td className="px-4 py-2 text-right font-medium text-blue-600">{day.webChats}</td>
                  <td className="px-4 py-2 text-right font-medium text-green-600">
                    {day.whatsappChats}
                  </td>
                  <td className="px-4 py-2 text-right font-medium text-purple-600">{day.quotes}</td>
                </tr>
              ))}
            </tbody>
          </table>
