...
| Módulo | Features |
|--------|----------|
| **Landing Page** | Home, Produtos (catálogo), Serviços, Portfólio, Contato, Orçamento |
| **WhatsApp IA** | Atendimento básico, coleta de dados, orçamento, agendamento |
| **Checkout** | Formulário de orçamento, agendamento, pagamento (PIX/Cartão) |
| **Portal Cliente** | Dashboard, ordens, orçamentos, agendamentos, documentos |
| **Admin Básico** | Dashboard, ordens, orçamentos, clientes, agenda |
| **Integrações** | Twilio, Claude, Stripe, NextAuth |

### ❌ FORA DO MVP (v2+)

| Feature | Motivo | Versão Planejada |
|---------|--------|------------------|
| App Mobile Nativo | Complexidade | v2.0 |
| Chat em tempo real (Socket) | Complexidade | v2.0 |
| IA com Vision avançada | Custo/Complexidade | v1.5 |
| Programa de indicação | Prioridade | v2.0 |
| Relatórios avançados | Prioridade | v1.5 |
| Múltiplos técnicos | Escala | v2.0 |
...
| Etapa | Campos | Prioridade |
|-------|--------|------------|
| 1. Categoria | Seleção de categoria | P0 |
| 2. Produto | Modelo, cor | P0 |
| 3. Medidas | Largura, altura, fotos | P0 |
| 4. Dados | Nome, email, telefone, endereço | P0 |
| 5. Resumo | Preview + estimativa | P0 |
| 6. Ação | Agendar visita OU WhatsApp | P0 |
...
| Manter contexto na conversa | ✅ | ✅ |
| Processar imagens (Vision) | ❌ | ✅ |
| Gerar documentos | ❌ | ✅ |
| Integrar com CRM | Básico | Avançado |
...
| Feature | Descrição | Prioridade |
|---------|-----------|------------|
| Chat completion | Respostas | P0 |
| Context management | Histórico | P0 |
| Vision | Análise de imagens | v2 |
...
*Versati Glass MVP Spec v1.0 - Dezembro 2024*
